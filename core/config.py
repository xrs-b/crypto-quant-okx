...
DEFAULT_ADAPTIVE_REGIME_CONFIG = {
    ...
    'guarded_execute': {
        ...
        'layering_profile_hints_enabled': False,
    ...
    def _get_default(self) -> Dict:
        ...
        return {
            ...
            'trading': {
                ...
                'close_outcome_feedback_guard': {
                    'enabled': True,
                    'lookback_limit': 20,
                    'min_sample_size': 5,
                    'block_modes': ['rollback'],
                    'tighten_modes': ['tighten'],
                    'require_freeze_for_block': True,
                    'tighten_entry_ratio_multiplier': 0.5,
                    'tighten_total_margin_cap_multiplier': 0.85,
                    'tighten_symbol_margin_cap_multiplier': 0.75,
                    'tighten_leverage_cap_multiplier': 0.7,
                    'floor_entry_margin_ratio': 0.02,
                    'floor_total_margin_cap_ratio': 0.10,
                    'floor_symbol_margin_cap_ratio': 0.05,
                    'floor_leverage_cap': 2,
                    'scoped_window_enabled': True,
                    'scoped_window_hours': 6,
                    'scoped_window_min_sample_size': 3,
                    'scoped_window_modes': ['rollback', 'tighten'],
                    'scope_priority': ['symbol_regime', 'symbol', 'regime', 'global'],
                },
                'layering': dict(DEFAULT_LAYERING_CONFIG),
            },
            'strategies': {
