...
class TestShadowValidationEntry(unittest.TestCase):
    ...
    def test_shadow_workflow_runner_supports_rollout_executor_dry_run_fixture(self):
        ...
        self.assertTrue(report['diff']['transition_policy']['enabled'])
        self.assertEqual(report['diff']['transition_policy']['transition_rule'], 'manual_gate_before_dispatch')
        self.assertEqual(report['diff']['transition_policy']['dispatch_route'], 'manual_review_queue')
        self.assertEqual(report['diff']['transition_policy']['next_transition'], 'await_manual_approval')
        self.assertEqual(report['diff']['transition_policy']['target_stage'], 'pending')
        self.assertEqual(report['diff']['transition_policy']['schema_version'], 'm5_rollout_transition_policy_v1')
        self.assertTrue(report['diff']['transition_policy']['consistency']['all_match'])
        self.assertEqual(report['diff']['transition_policy']['snapshot']['transition_rule'], 'queue_only_followup_required')
        self.assertEqual(report['diff']['transition_policy']['snapshot']['dispatch_route'], 'stage_promotion_queue')
        self.assertEqual(report['diff']['transition_policy']['snapshot']['next_transition'], 'queue_for_followup_execution')
        self.assertEqual(report['diff']['transition_policy']['materialized_rule']['transition_rule'], 'manual_gate_before_dispatch')
        self.assertEqual(report['diff']['transition_policy']['materialized_rule']['dispatch_route'], 'manual_review_queue')
    ...
    def test_validation_replay_outputs_aggregated_summary(self):
        ...
        self.assertEqual(replay['summary']['transition_policy']['route_counts']['safe_state_apply'], 2)
        self.assertEqual(replay['summary']['transition_policy']['route_counts']['manual_review_queue'], 1)
        self.assertEqual(replay['summary']['transition_policy']['next_transition_counts']['mark_ready_for_followup'], 2)
        self.assertEqual(replay['summary']['transition_policy']['next_transition_counts']['await_manual_approval'], 1)
        self.assertEqual(replay['summary']['transition_policy']['consistent_case_count'], 3)
